...
$query = "SELECT orders.*, products.title AS product, 
    customers.name AS customer, customers.email,
    customers.shipping_address AS address  
    FROM orders
    LEFT JOIN products ON products.id = orders.product_id
    LEFT JOIN customers ON customers.id = orders.customer_id
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <a href="manage_orders.php"><i class="fa fa-refresh"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($order['status'] == 'pending') { ?>
                                                    <a href="./manage_orders.php?id=<?php echo $order['id']; ?>&&status=<?php echo $order['status']; ?>">
